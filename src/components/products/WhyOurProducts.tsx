...
const features = [
  {
    ...
    description: "Hospital-grade wipes ensure maximum hygiene.",
    icon: (
      <svg
        className="w-6 h-6"
        fill="none"
  ...
  {
    title: "User-Friendly",
    description: "Sleek dispensers are easy to use and refill.",
    icon: (
      <svg
        className="w-6 h-6"
        fill="none"
  ...
  },
  {
    ...
    description: "Complements modern business aesthetics.",
    icon: (
      <svg
        className="w-6 h-6"
        fill="none"
  ...
  {
    title: "Fast Delivery",
    description: "Orders delivered within 24 hours in Sydney.",
    icon: (
      <svg
        className="w-6 h-6"
        fill="none"
